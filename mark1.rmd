...
### Correlation of other attributes with 'total weekly hours worked'

```{r}
barplot(sort(datacopy[,1]),col="BLUE",horiz = TRUE,las=1,main="Correlation of other attributes with 'total weekly hours worked' ")
```

### Correlation Matrix

```{r}
pairs(country_mat,col="green",pch=19,main="Correlation Matrix")
```
